exports.findAppIdsTest = function () {
    ...
    const app1Output = utils.findAppIds(app1).then(app => console.log("OUTPUT", app));


    console.log(`${GREEN}AppEntity instance Input: app1${RESET}`, app1);
    //console.log(`${BLUE}AppEntity instance Output: app1Output${RESET}`, app1Output);


}
exports.findAppIdsTest();
